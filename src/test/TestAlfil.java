...
public class TestAlfil extends TestPiezas {
	...
	public void testMovimientoAlfilBlanco1 () {
		...
		DatosPrueba prueba = new DatosPrueba(alfilBlanco1,
				"Error al comprobar movimientos del alfil blanco en la posicion (1,c) rodeado de piezas blancas");
	...
	public void testMovimientoAlfilBlanco2 () {
		...
		DatosPrueba prueba = new DatosPrueba(alfilBlanco2,
				"Error al comprobar movimientos del alfil blanco en la posicion (1,f) y despejadas la diagonal superior izquierda y la diagonal superior derecha");
		boolean res = this.testMovimientos(prueba); 
		assertTrue(prueba.getMensaje(), res);
	...
	public void testMovimientoAlfilBlanco3 () {
		...
		DatosPrueba prueba = new DatosPrueba(alfilBlanco3,
				"Error al comprobar movimientos del alfil blanco en la posicion (4,c) con piezas negras en todas las diagonales");
		boolean res = this.testMovimientos(prueba); 
		assertTrue(prueba.getMensaje(), res);
	...
	public void testMovimientoAlfilBlanco4 () {
		...
		DatosPrueba prueba = new DatosPrueba(alfilBlanco4,
				"Error al comprobar movimientos del alfil blanco en la posicion (1,c) y con piezas blanca en 2b, la caislla 2d está vacía " + 
				" y hay un peon blanco en 3e");
		boolean res = this.testMovimientos(prueba); 
		assertTrue(prueba.getMensaje(), res);
	...
	public void testMovimientoAlfilNegro1 () {
		...
		DatosPrueba prueba = new DatosPrueba(alfilNegro1,
				"Error al comprobar movimientos del alfil negro en la posicion (8,c) con la diagonal infeiror izquierda "
				+ "bloqueda por una pieza negra en (7,b) y la diagonal inferiro derecha está bloqueda por una pieza blanca en (4,g)");
		boolean res = this.testMovimientos(prueba); 
		assertTrue(prueba.getMensaje(), res);
	}
	...
	public void testMovimientoAlfilNegro2 () {
		...
		DatosPrueba prueba = new DatosPrueba(alfilNegro2,
				"Error al comprobar movimientos del alfil negro en la posicion (8,f) con la diagonal infeiror izquierda "
	...
	public void testMovimientoAlfilNegro3 () {
		...
		DatosPrueba prueba = new DatosPrueba(alfilNegro3,
				"Error al comprobar movimientos del alfil negro en la posicion (5,e) y obstáculos pieza negra en (7,c), "
				+ "pieza negra en (7,g), pieza blanca en (2,b) y pieza blanca en (3,g)" );
		boolean res = this.testMovimientos(prueba); 
		assertTrue(prueba.getMensaje(), res);
	}
	...
	public void testMovimientoAlfilNegro4 () {
		...
		DatosPrueba prueba = new DatosPrueba(alfilNegro4,
				"Error al comprobar movimientos del alfil negro en la posicion (8,c) y obstáculo pieza negra en (5,f)");
		boolean res = this.testMovimientos(prueba); 
		assertTrue(prueba.getMensaje(), res);
	}
}
