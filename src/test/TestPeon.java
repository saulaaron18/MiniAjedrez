...
public class TestPeon extends TestPiezas {
	...
	//2018-12-03 ALGM: Verificar que no se mueve de incio dos casillas cuando hay contrario
	private final String peonBlanco5 ="2f,3e,3f,3g";
	//Peon negro
	...
	//2018-12-03 ALGM: Verificar que no se mueve de incio dos casillas cuando hay contrario
	private final String peonNegro6="7b,6a,6b";
	...
	public void testSalirTableroPeon () {
		PiezaAjedrez.setQueHay((fila,columna) -> super.nuncaHayPieza(fila, columna)); 
		...
		IList<Casilla> res = peonBlanco.movimientosValidos();
	...
	public void testMovimientoPeonBlanco1 () {
		...
		DatosPrueba prueba = new DatosPrueba(peonBlanco1,
				"Error al comprobar movimienos del peon blanco en la posicion (2,b) con un peon negro en posición (3,c).");
	...
	//2018-11-03 ALGM
	/**
	 * Este test prueba el escenario en el que tenemos un peon blanco en la posición (2,f),
	 *  y en la casilla (4,f) hay otro peon blanco y peones negros en (3,e) y (3,g) 
	 * tiene vacía  y una pieza contraria en la caislla diagonal superior dericha y diagonal inferior izquierda
	 */
	@Test
	public void testMovimientoPeonBlanco5 () {
		this.cargarPartidaTest(partidaPeon);
		DatosPrueba prueba = new DatosPrueba(peonBlanco5, 
				"Error al comprobar movimienos del peon blanco en la posicion (2,f), y en la casilla (4,f) hay un peon blanco y peones negros en (3,e) y (3,g)");
		boolean res = this.testMovimientos(prueba); 
		assertTrue(prueba.getMensaje(), res);
	...
	/**
	 * Este test prueba el escenario en el que tenemos un peon negro en la posición (7,b), con peones blanco en casilla 
	 * diagonal inferiorizquierda (6,a) y con peon negro en casilla (5,b)
	 * */
	@Test
	public void testMovimientoPeonNegro6 () {
		this.cargarPartidaTest(partidaPeon);
		DatosPrueba prueba = new DatosPrueba(peonNegro6, 
				"Error al comprobar movimienos del peon negro en la posicion (7,b) con peones blanco en casilla" + 
				" diagonal inferiorizquierda (6,a) y con peon negro en casilla (5,b)");
		boolean res = this.testMovimientos(prueba); 
		assertTrue(prueba.getMensaje(), res);
	}
